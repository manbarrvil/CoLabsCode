...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            dict_POI = client_Modbus(ident_emec_id_POI, data)
            print(dict_POI, '\n')
            ...
            dict_SS1 = client_Modbus(ident_emec_id_SS1, data)
            print(dict_SS1, '\n')
            ...
            dict_SS2 = client_Modbus(ident_emec_id_SS2, data)
            print(dict_SS2, '\n')
            ...
            write_DB_CSL_BROKER_INPUT(t, meas_POI[0], meas_POI[1], meas_POI[2], meas_POI[3], meas_POI[4], meas_POI[5], meas_POI[6], meas_POI[7], meas_POI[8], meas_POI[9], meas_POI[10], meas_POI[11], meas_POI[12], meas_POI[13], meas_POI[14], meas_POI[15], 
